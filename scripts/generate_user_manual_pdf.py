...
DEFAULT_OUTPUT = PROJECT_ROOT / "docs" / "WBPriceAnalyzer_Instruction_v0.2.15.pdf"
VERSION = "0.2.15"
...
def build_story() -> list[object]:
    ...
    story.extend(
        [
            ...
            Spacer(1, 13 * mm),
            callout(
                "Главное в версии 0.2.15",
                "Интерфейс приведён к OZ Price Analyzer 0.5.30: карточки «Чистая прибыль "
                "товаров» и «Чистая прибыль от деятельности», фильтр нескольких категорий, "
                "карточки сценария под таблицей, «Открыть отдельно» в развёрнутом режиме, "
                "масштаб интерфейса и кнопки шапки в одну строку.",
            ),
            Spacer(1, 27 * mm),
        ...
        [
            ...
            data_table(
                ...
                [
                    ...
                    ["Чистая прибыль от деятельности", "Прибыль всего отчёта с нераспределёнными и её доходность относительно с/с проданного."],
                ],
                [57, 109],
            ),
    ...
    story.extend(
        [
            ...
            p("Категория, артикул, метрика сортировки и направление применяются к таблице. "
              "Фильтры закреплены над таблицей и переносятся на новые строки при нехватке ширины. "
