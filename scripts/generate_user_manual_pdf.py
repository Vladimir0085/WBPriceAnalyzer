...
DEFAULT_OUTPUT = PROJECT_ROOT / "docs" / "WBPriceAnalyzer_Instruction_v0.2.14.pdf"
VERSION = "0.2.14"
...
def build_story() -> list[object]:
    ...
    story.extend(
        [
            ...
            Spacer(1, 13 * mm),
            callout(
                "Главное в версии 0.2.14",
                "Категория, поиск и сортировка закреплены над таблицей и переносятся "
                "на новые строки в узком окне. Сводка показателей прокручивается отдельно. "
                "Фильтры доступны и в полноэкранном режиме таблицы.",
            ),
            Spacer(1, 27 * mm),
            plain("Актуально на 22.09.2026", "small"),
    ...
    story.extend(
        [
            ...
            p("Категория, артикул, метрика сортировки и направление применяются к таблице. "
              ...
              "сводку, сохраняя фильтры. «Отдельно» открывает синхронизированную таблицу в новом окне."),
            PageBreak(),
        ]
    )
